...
|[LC0066](https://github.com/StefanMaron/BusinessCentral.LinterCop/wiki/LC0067)|Informs the user that there are missing permission to access tabledata.|Warning|
